...
# Date
time = '2025-05-22T22:45:09'
# Wavelengths
lambda_a = 171
lambda_b = 335

dates = ['2025-05-22T22:45:09','2025-05-22T22:45:45','2025-05-22T10:28:57','2025-05-22T22:45:33','2025-05-22T22:45:09','2025-05-22T22:45:09','2025-05-22T22:45:33']
l1pt5_171 = []
l1pt5_335 = []
...
def lvl_1pt5(day, l1, l2):
    ...
    t_begin = parse_time('2025-05-22T00:00:00')
    ...
    ###################################
    ## Plots the final 171 Angstrom 
    ## image after each iteration
    ##Checking Functionality: fig = plt.figure()
    ##Checking Functionality: ax = fig.add_subplot(projection=m_a_corrected)
    ##Checking Functionality: m_a_corrected.plot(axes=ax)
    ##Checking Functionality: plt.colorbar()
    ##Checking Functionality: plt.show()
