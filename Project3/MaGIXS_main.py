...
if __name__ == '__main__':
    ...
    print("Source Coordinates: [%.14f,%.14f,%.14f]"%(x_coord,y_coord,z_coord))

    source = Source(center=(x_coord,y_coord,-z_coord),width=modR_w*4, 
                    height=modR_w*4, normal=(-x_coord,-y_coord,z_coord))
    """
    Parameters:
